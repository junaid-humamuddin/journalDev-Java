...
public class JavaFileScanner {
	...
	public static void main(String[] args) throws IOException {
		/**
		 * My Name is Pankaj My website is journaldev.com Phone : 1234567890
		 */
		...
		/**
		 * Pankaj,28,Male Lisa,30,Female Mike,25,Male
		 */
		scanner = new Scanner(Paths.get("C:/Users/junaid/data.csv"));
		scanner.useDelimiter(System.getProperty("line.separator"));
		while (scanner.hasNext()) {
